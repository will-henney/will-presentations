...
\begin{frame}
  ...
  \begin{block}{Hypothesis}
    ...
    \item With important supporting roles for
      ...
      %   \node[big role] (wind) {Stellar winds};
      %   \node[big role] (magnetic) [left of=wind] {Magnetic fields};
      %   \node[big role] (instabilities) [right of=wind] {Instabilities};
      %   \node[small role] (radpress) [below of=wind] {Radiation pressure};
      %   \node[small role] (gravity) [below of=instabilities] {Gravity};
      % \end{tikzpicture}
    \end{itemize}
  \end{block}
\end{frame}
